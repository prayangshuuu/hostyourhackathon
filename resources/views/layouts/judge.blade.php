...
<head>
    ...
    <title>@yield('title', 'Judging') — {{ config('app.name') }}</title>
    <meta name="description" content="@yield('meta_description', 'Judging panel on ' . config('app.name'))">
...
<body class="organizer-shell">
    ...
    {{-- Sidebar --}}
    @include('components.judge.sidebar')
