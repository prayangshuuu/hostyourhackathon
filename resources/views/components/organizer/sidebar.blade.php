{{-- Organizer Sidebar --}}
<aside class="sidebar" role="navigation" aria-label="Organizer navigation">
    {{-- Logo --}}
    ...
    <nav>
        ...
        <a href="{{ route('organizer.hackathons.index') }}"
           class="sidebar-nav-item {{ request()->routeIs('organizer.hackathons.*') ? 'active' : '' }}">
